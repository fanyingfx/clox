...
static void runFile(const char *path) {
    ...
    // This means we don’t need to worry about managing memory for lexemes at all and we can freely copy tokens around.
    // As long as the main source code string outlives all of the tokens, everything works fine.
